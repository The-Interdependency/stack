...
- occupied_target_collision: SURVIVED (family=smoke, turns=1, events=4, replay_equal=True, invalid_actions=0, refusals=0) - War resolved deterministically: defender-holds for occupied targets, priority for dual targets
