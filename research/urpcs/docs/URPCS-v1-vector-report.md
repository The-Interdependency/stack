...
| `urpcs_v1_reference.py` | `3bcdfcd7a81ea3ce32b757b5912ffffcb5371ae63990f2e7146f03ce6e439650` |

## Usage guidance

Run the complete positive and negative suite:
...
Then compare its SHA-256 value with the receipt above. Python 3.10 or newer is
required; the implementation uses only the standard library.
