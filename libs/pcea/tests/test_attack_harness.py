...
def test_carrier_law_leaks_factor_support():
    ...
    assert set(r["leaked_support"]) == union


def test_oracle_domain_is_highly_recoverable():
...
def test_pruning_eliminates_substantial_search_space():
    A, B = ah._obj([8]), ah._obj([5])
