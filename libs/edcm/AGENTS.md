name: edcm
description: |
  Energy–Dissonance Circuit Model research and measurement repository. Preserve the frozen maintained baseline as a candidate, keep METAPAT affixiation semantics / UCNS geometry / English Gonol Construction text construction distinct, run the exact UCNS–EDCM experiment graph, and never transfer proof, empirical validity, or canon status across repository boundaries. Text-domain gonol construction moved to stack research/english-gonol; EDCM may evaluate its outputs but must not define the construction.

# === LLMS ===
# id: edcm_agent_overview
#   content: EDCM has a frozen maintained measurement baseline and an experiment-first UCNS–EDCM research surface. English text-domain gonol construction moved to stack research/english-gonol; EDCM may evaluate its outputs but must not define the construction. METAPAT owns affixiation semantics; UCNS owns gonol/Möbius/Public Gonol geometry and geometrically established operations; English Gonol Construction owns text-domain admission and linguistic/semantic gonol construction, including the rule that every admitted character is a gonol. Construction does not activate EDCM measurement. The baseline is candidate edcm-measurement-v1, not automatic joint canon. Preserve NA != 0 and all semantic/geometry/construction/measurement non-transfer boundaries.
#
# id: edcm_agent_usage
#   content: Read CANON.md, README.md, docs/UCNS_EDCM_EXPERIMENT_PROGRAM.md, CLAUDE.md, and the applicable organization skills before editing. For text-gonol work start in stack research/english-gonol and follow its docs/GONOL_LANGUAGE_BOUNDARY.md and .agents/skills/gonol-build/SKILL.md; consume current METAPAT affixiation invariants and current UCNS geometry, keep unresolved geometric operations hmmm, and independently replay claimed completed constructions. For joint measurements freeze the EDCM projection and falsifier separately.
# === END LLMS ===
...
3. [`research/english-gonol/.agents/skills/gonol-build/SKILL.md`](../../research/english-gonol/.agents/skills/gonol-build/SKILL.md) for gonol, character, word, definition, recursive-relation, or affixiation work
4. `README.md`
...
English Gonol Construction:   stack research/english-gonol (text-domain admission and linguistic/semantic gonol construction)
...
English Gonol Construction owns the character-admission profile and linguistic/semantic construction. UCNS owns the geometry used to realize admitted gonols. METAPAT owns the meaning of affixiation. Do not move either semantic authority into UCNS merely because UCNS supplies the carrier. EDCM may evaluate English Gonol outputs but must not define the construction.
...
- English text-domain gonol admission and construction live in stack `research/english-gonol/`; EDCM measurement remains separately frozen and evaluated.
- `edcm.gonol` candidate constructor moved to `research/english-gonol/english_gonol/gonol.py` with its constructor identity retained; none of its scale options is selected canon.
...
- `NA != 0`.
- every admitted character is a gonol for active English Gonol text construction.
- METAPAT defines affixiation; English Gonol Construction applies it; UCNS realizes its geometry where constructed.
...
For new text-gonol construction, begin in [`research/english-gonol/`](../../research/english-gonol/). Resolve the exact English Gonol source/admission profile, import METAPAT affixiation invariants without redefining them, consume current UCNS geometry where normally available, and close gonols with the moved `edcm.gonol` scale option sets (now importable as `english_gonol.gonol`). Once closed, a gonol is atomic at any scale; admissible larger-scale construction may consume closed gonols directly without reopening. Replay independently before claiming completion. Let EDCM freeze any measurement only after construction and keep its evidence status separate.
